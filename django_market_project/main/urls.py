...
urlpatterns = [
    ...
    path('add_inventory/<str:item_name>/', views.add_inventory, name='add-inventory-page'),
    path('cancel_item/<str:cancel_item_pk>/', views.cancel_item, name='cancel-item-page'),
